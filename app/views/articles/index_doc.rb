...
# Explanation: The resources method also sets up URL and path helper methods that we can use to keep our code from depending on a specific route configuration. 
# Type in: bin/rails routes command. The values in the "Prefix" column plus a suffix of _url or _path form the names of these helpers
